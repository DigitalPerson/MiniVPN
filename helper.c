...
int do_aes_128_cbc_crypt(unsigned char inbuf[], int inlen,
...
void calculate_md5_hash(unsigned char inbuf[], int inlen,
...
void calculate_sha256_hash(unsigned char inbuf[], int inlen,
		unsigned char outbuf[], int* outlen) {
	EVP_MD_CTX *mdctx;
	const EVP_MD *md;
	OpenSSL_add_all_digests();
...
void calculate_sha256_hash_with_salt(unsigned char salt[], int saltlen,
